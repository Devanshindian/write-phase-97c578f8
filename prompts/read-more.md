...
────────────────────────────────────────────────────────────────────────
THE RULES:
- ZERO is the normal, expected outcome. Add a pointer ONLY when a candidate genuinely deepens a
  sub-topic this article raises. One is common when it happens; two is the absolute maximum.
...
(pointers is [] when nothing qualifies — the usual answer)
